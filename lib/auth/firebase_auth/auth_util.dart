...
DocumentReference? get currentUserReference =>
    loggedIn ? UserInfoRecord.collection.doc(currentUser!.uid) : null;

UserInfoRecord? currentUserDocument;
final authenticatedUserStream = FirebaseAuth.instance
    ...
    .switchMap(
      (uid) => uid.isEmpty
          ? Stream.value(null)
          : UserInfoRecord.getDocument(UserInfoRecord.collection.doc(uid))
              .handleError((_) {}),
    )
    .map((user) {
