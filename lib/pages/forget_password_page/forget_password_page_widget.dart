...
class ForgetPasswordPageWidget extends StatefulWidget {
  ...
  static String routePath = '/forgetPasswordPage';
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: Text(
                  FFLocalizations.of(context).getText(
                    'v6pt8w3j' /* We will send you an email with... */,
                  ),
